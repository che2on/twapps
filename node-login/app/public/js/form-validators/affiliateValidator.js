...
// build array maps of the form inputs & control groups //
	...
	this.formFields = [$('#name-tf'), $('#email-tf'), $('#user-tf') ];
	this.controlGroups = [$('#name-cg'), $('#email-cg'), $('#user-cg')];
...
AccountValidator.prototype.showInvalidCode = function()
{
	this.controlGroups[2].addClass('error');
	this.showErrors(['That code is already in use.']);
}
...
AccountValidator.prototype.validateForm = function()
{
	...
	if (this.validateName(this.formFields[2].val()) == false) {
		this.controlGroups[2].addClass('error');
		e.push('Please Choose a Valid Code');
	}
